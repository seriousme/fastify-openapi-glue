...
class generator {
  ...
  generateProject(dir, project) {
    ...
    for (const service of services) {
      const hash = crypto.createHash("sha256")
      hash.update(service.data)
      this.generated.files[service.fileName] = {
        fileName: service.fileName,
        checksum: hash.digest("hex")
      }
      if(!this.checksumOnly){
        this.generated.files[service.fileName].path = service.path
        writeFileSync(service.path, service.data, fileOpts)
      }
    }
